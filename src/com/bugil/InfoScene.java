...
public class InfoScene extends BaseScene implements IOnMenuItemClickListener
{
	//---------------------------------------------
	// VARIABLES
	//---------------------------------------------
	...
	{
		attachChild(new Sprite(240, 400, resourcesManager.info_background_region, vbom)
		{
    		@Override
